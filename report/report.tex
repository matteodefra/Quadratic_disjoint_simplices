...
Lastly, regarding the stopping condition for the algorithm termination, we can check primal and dual variables. Follows that, given a certain value of tolerance $\varepsilon$, we have %respectively for the primal and dual variables
\begin{equation}
...
\begin{flushleft}
  \begin{minipage}{\textwidth}
    \begin{algorithm}[H]
      ...
      \label{alg:my_alg}
      \begin{algorithmic}
        \Function{\texttt{ADAGRAD}}{$\eta$, $\delta$, $\varepsilon$, $max\_iter$, $defl$}
...
and a non-arbitrary number of zeros based on a certain probability.\\
...
Lastly, we can observe that using the deflection result in a more "stable" optimization, with the value of $\mathcal{L}$ oscillating in a certain interval. In addition, the update rule $2$ (which does not depend on the previous $\lambda$) 
seems to be the most effective in general.\\[1em]
We can report now some plots comparing the results of the executions obtained together with the total time spent in the algorithm execution, with fixed value of $n=40$ and number of simplices set $K=30$ we will see the execution using the 
three different update rules.

% \newgeometry{left=0.5cm, right=0.5cm, bottom=0.5cm, top=0.5cm}

% \begin{center}
%   {\large\bfseries Update rule $\mathbf{1}$}  
% \end{center}

% \begin{figure}[H]
%   \begin{subfigure}{.49\textwidth}
%     \centering
%     \includegraphics[scale=0.11]{pics/n=40/Convergence_rule=1_n=40_K=30_defl=false_gap=335.05.png}
%   \end{subfigure}
%   \begin{subfigure}{.5\textwidth}
%     \centering
%     \includegraphics[scale=0.11]{pics/n=40/Convergence_rule=1_n=40_K=30_defl=true_gap=28.9.png}
%   \end{subfigure}
%   \caption{Convergence of dual function}
%   \label{fig:rule-1-n-40-k-30}
% \end{figure}
% \begin{figure}[H]
%   \begin{subfigure}{.49\textwidth}
%     \centering
%     \includegraphics[scale=0.11]{pics/n=40/Gaps_rule=1_n=40_K=30_defl=false.png}
%   \end{subfigure}
%   \begin{subfigure}{.5\textwidth}
%     \centering
%     \includegraphics[scale=0.11]{pics/n=40/Gaps_rule=1_n=40_K=30_defl=true.png}
%   \end{subfigure}
%   \caption{Gaps of the previous example}
%   \label{fig:rule-1-n-40-k-30-gaps}
% \end{figure}
% \begin{figure}[H]
%   \begin{subfigure}{.49\textwidth}
%     \centering
%     \includegraphics[scale=0.11]{pics/n=40/Residual_rule=1_n=40_K=30_defl=false.png}
%   \end{subfigure}
%   \begin{subfigure}{.5\textwidth}
%     \centering
%     \includegraphics[scale=0.11]{pics/n=40/Residual_rule=1_n=40_K=30_defl=true.png}
%   \end{subfigure}
%   \caption{Residual $\lambda$ of the previous example}
%   \label{rule-1-n-40-k-30-lambda}
% \end{figure}
% \begin{figure}[H]
%   \begin{subfigure}{.49\textwidth}
%     \centering
%     \includegraphics[scale=0.11]{pics/n=40/Residual_x_rule=1_n=40_K=30_defl=false.png}
%   \end{subfigure}
%   \begin{subfigure}{.5\textwidth}
%     \centering
%     \includegraphics[scale=0.11]{pics/n=40/Residual_x_rule=1_n=40_K=30_defl=true.png}
%   \end{subfigure}
%   \caption{Residual $x$ of the previous example}
%   \label{fig:rule-1-n-40-k-30-x}
% \end{figure}

% \newpage

% \begin{center}
%   {\large\bfseries Update rule $\mathbf{2}$}
% \end{center}

% \begin{figure}[H]
%   \begin{subfigure}{.49\textwidth}
%     \centering
%     \includegraphics[scale=0.11]{pics/n=40/Convergence_rule=2_n=40_K=30_defl=false_gap=357.08.png}
%   \end{subfigure}
%   \begin{subfigure}{.5\textwidth}
%     \centering
%     \includegraphics[scale=0.11]{pics/n=40/Convergence_rule=2_n=40_K=30_defl=true_gap=28.9.png}
%   \end{subfigure}
%   \caption{Convergence of dual function}
%   \label{fig:rule-2-n-40-k-30}
% \end{figure}
% \begin{figure}[H]
%   \begin{subfigure}{.49\textwidth}
%     \centering
%     \includegraphics[scale=0.11]{pics/n=40/Gaps_rule=2_n=40_K=30_defl=false.png}
%   \end{subfigure}
%   \begin{subfigure}{.5\textwidth}
%     \centering
%     \includegraphics[scale=0.11]{pics/n=40/Gaps_rule=2_n=40_K=30_defl=true.png}
%   \end{subfigure}
%   \caption{Gaps of the previous example}
%   \label{fig:rule-2-n-40-k-30-gaps}
% \end{figure}
% \begin{figure}[H]
%   \begin{subfigure}{.49\textwidth}
%     \centering
%     \includegraphics[scale=0.11]{pics/n=40/Residual_rule=2_n=40_K=30_defl=false.png}
%   \end{subfigure}
%   \begin{subfigure}{.5\textwidth}
%     \centering
%     \includegraphics[scale=0.11]{pics/n=40/Residual_rule=2_n=40_K=30_defl=true.png}
%   \end{subfigure}
%   \caption{Residual $\lambda$ of the previous example}
%   \label{fig:rule-2-n-40-k-30-lambda}
% \end{figure}
% \begin{figure}[H]
%   \begin{subfigure}{.49\textwidth}
%     \centering
%     \includegraphics[scale=0.11]{pics/n=40/Residual_x_rule=2_n=40_K=30_defl=false.png}
%   \end{subfigure}
%   \begin{subfigure}{.5\textwidth}
%     \centering
%     \includegraphics[scale=0.11]{pics/n=40/Residual_x_rule=2_n=40_K=30_defl=true.png}
%   \end{subfigure}
%   \caption{Residual $x$ of the previous example}
%   \label{fig:rule-2-n-40-k-30-x}
% \end{figure}

% \newpage

% \begin{center}
%   {\large\bfseries Update rule $\mathbf{3}$}
% \end{center}

% \begin{figure}[H]
%   \begin{subfigure}{.49\textwidth}
%     \centering
%     \includegraphics[scale=0.11]{pics/n=40/Convergence_rule=3_n=40_K=30_defl=false_gap=389.13.png}
%   \end{subfigure}
%   \begin{subfigure}{.5\textwidth}
%     \centering
%     \includegraphics[scale=0.11]{pics/n=40/Convergence_rule=3_n=40_K=30_defl=true_gap=28.9.png}
%   \end{subfigure}
%   \caption{Convergence of dual function}
%   \label{fig:rule-3-n-40-k-30}
% \end{figure}
% \begin{figure}[H]
%   \begin{subfigure}{.49\textwidth}
%     \centering
%     \includegraphics[scale=0.11]{pics/n=40/Gaps_rule=3_n=40_K=30_defl=false.png}
%   \end{subfigure}
%   \begin{subfigure}{.5\textwidth}
%     \centering
%     \includegraphics[scale=0.11]{pics/n=40/Gaps_rule=3_n=40_K=30_defl=true.png}
%   \end{subfigure}
%   \caption{Gaps of the previous example}
%   \label{fig:rule-3-n-40-k-30-gaps}
% \end{figure}
% \begin{figure}[H]
%   \begin{subfigure}{.49\textwidth}
%     \centering
%     \includegraphics[scale=0.11]{pics/n=40/Residual_rule=3_n=40_K=30_defl=false.png}
%   \end{subfigure}
%   \begin{subfigure}{.5\textwidth}
%     \centering
%     \includegraphics[scale=0.11]{pics/n=40/Residual_rule=3_n=40_K=30_defl=true.png}
%   \end{subfigure}
%   \caption{Residual $\lambda$ of the previous example}
%   \label{fig:rule-3-n-40-k-30-lambda}
% \end{figure}
% \begin{figure}[H]
%   \begin{subfigure}{.49\textwidth}
%     \centering
%     \includegraphics[scale=0.11]{pics/n=40/Residual_x_rule=3_n=40_K=30_defl=false.png}
%   \end{subfigure}
%   \begin{subfigure}{.5\textwidth}
%     \centering
%     \includegraphics[scale=0.11]{pics/n=40/Residual_x_rule=3_n=40_K=30_defl=true.png}
%   \end{subfigure}
%   \caption{Residual $x$ of the previous example}
%   \label{fig:rule-3-n-40-k-30-x}
% \end{figure}
